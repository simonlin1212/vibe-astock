...
# 6to4 2002::/16、0.0.0.0/8、240.0.0.0/4 都算 private),而且属性语义随 CPython 版本
# 变化。云厂商的实例元数据服务住在 169.254.169.254,IPv4-mapped 与 6to4 都能把它重新
# 编码一遍,而这两种写法的属性在不同版本上恰好相反:
#   3.9.6   ::ffff:169.254.169.254 is_link_local=False(漏) | 2002:a9fe:a9fe:: is_private=False
